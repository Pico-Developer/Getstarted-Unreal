...
public:
  ...
  /** FXRRenderTargetManager interface */
	...
	void SetExternalSurfaceLayer(const IStereoLayers::FLayerDesc& InLayerDesc, bool IsDRM, EPICOXRAndroidSurface3DType Type);
	void DestroyMRCLayer();
	void DestroyExternalSurfaceLayer();
	...
	FPICOLayerPtr CurrentExternalSurfaceLayer;
	// Render thread
