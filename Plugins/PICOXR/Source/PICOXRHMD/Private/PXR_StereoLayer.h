...
class FPxrExternalSurface : public TSharedFromThis<FPxrExternalSurface, ESPMode::ThreadSafe>
{
public:
	FPxrExternalSurface() {}
	~FPxrExternalSurface() {}
#if PLATFORM_ANDROID
	jobject* GetSurface() { return &AndroidExternalSurface; }
protected:
	jobject AndroidExternalSurface;
#endif
};

typedef TSharedPtr<FPxrExternalSurface, ESPMode::ThreadSafe> FPxrExternalSurfacePtr;
...
public:
	...
	EPICOXRAndroidSurface3DType SurfaceType;
#if PLATFORM_ANDROID
	jobject* GetAndroidExternalSurface();
#endif
...
#endif
	FPxrExternalSurfacePtr ExternalSurface_RenderThreadValid;
