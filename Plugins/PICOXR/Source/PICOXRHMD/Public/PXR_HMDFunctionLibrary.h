...
#pragma  endregion Boundary
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRHMD")
	static bool PXR_SetExternalSurface(FVector Translation, FRotator Rotation, FVector2D Size, bool IsDRM, EPICOXRAndroidSurface3DType Type);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRHMD")
	static void PXR_DestroyExternalSurface();
	/**
	* Select Coordinate.
