...
bool UPXR_FaceTrackingComponent::InitializeFaceTracking()
{
	...
	if (FTTargetMeshComponent && FTTargetMeshComponent->SkeletalMesh)
	{
		const TMap<FName, int32>& MorphTargetIndexMap = FTTargetMeshComponent->SkeletalMesh->GetMorphTargetIndexMap();
