...
typedef enum {
    ...
    ppfMessageType_User_GetIdToken = 10010,
    ppfMessageType_User_EntitlementCheck = 10011,
    ppfMessageType_User_GetOrgScopedID = 10012,
    ...
    ppfMessageType_Matchmaking_Browse2CustomPage                        = 10401,
    ...
    ppfMessageType_Room_JoinNamed                                       = 10520,
    ppfMessageType_Room_GetNamedRooms                                   = 10521,
    ...
    ppfMessageType_IAP_GetSubscriptionStatus = 12005,
    ...
    ppfMessageType_Notification_Speech_OnAsrResult = 14001,
    ppfMessageType_Notification_Speech_OnSpeechError = 14002,
    ppfMessageType_Compliance_DetectSensitive = 15015,

    ppfMessageType_Highlight_StartSession = 15110,
    ppfMessageType_Highlight_CaptureScreen = 15111,
    ppfMessageType_Highlight_StartRecord = 15112,
    ppfMessageType_Highlight_StopRecord = 15113,
    ppfMessageType_Highlight_ListMedia = 15114,
    ppfMessageType_Highlight_SaveMedia = 15115,
    ppfMessageType_Highlight_ShareMedia = 15116,
    ppfMessageType_Notification_Highlight_OnRecordStop=15150,
} ppfMessageType;
#endif
